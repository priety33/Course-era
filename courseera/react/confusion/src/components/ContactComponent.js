...
// checks to see that the value is greater than zero
...
//value attribute ties the form to the controlled componenets state
//size:6 offset:3, leave 3 columns in left and then occupy 6 columns
