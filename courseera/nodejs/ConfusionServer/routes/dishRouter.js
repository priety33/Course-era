    ...
    .then((dish) => {
        if(dish!=null) {
            for( var i= (dish.comments.length-1); i>=0; i--) {
                // to access subdocument => .id(subdocument._id)
